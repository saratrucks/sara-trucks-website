      ...
      <div className="min-h-screen bg-background">
        ...
        <div className="bg-primary text-white py-16 relative overflow-hidden">
          ...
          <div className="container relative z-10">
            ...
            <AdminCatalogActions catalog="equipment" />
          </div>
        </div>
          ...
          {isLoading ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {filteredEquipment.map((item: any) => (
                <Card key={item.id} className="relative overflow-hidden border-none shadow-lg hover:shadow-xl transition-all duration-300 group flex flex-col h-full">
                  <div className="absolute left-4 top-4 z-20">
                    <AdminItemEditButton catalog="equipment" id={item.id} />
                  </div>
